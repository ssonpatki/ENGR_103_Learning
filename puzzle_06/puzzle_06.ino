/* Create a program so that the Circuitboard displays through different light patterns when 
buttons are pressed; light patterns will not display is switch is off */
